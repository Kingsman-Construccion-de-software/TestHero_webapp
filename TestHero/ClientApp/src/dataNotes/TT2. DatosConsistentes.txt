...
-- Alumno (5 cuentas)
insert into alumno (nombres, apellidos, correo, password, idGrupo) values ('Rosa', 'Casio', 'rcasio@hotmail.com', '123rosaca', 8);
insert into alumno (nombres, apellidos, correo, password, idGrupo) values ('Joaquin', 'Rodríguez', 'joaquinrdz@gmail.com', 'j04qu1n', 8);
insert into alumno (nombres, apellidos, correo, password, idGrupo) values ('Rafael', 'Urbina', 'rafiqui@gmail.com', 'rafix777', 8);
insert into alumno (nombres, apellidos, correo, password, idGrupo) values ('Daniel', 'González', 'dgonzalez@udem.edu', '07DaniBoi07', 8);
insert into alumno (nombres, apellidos, correo, password, idGrupo) values ('Nicolás', 'Cajas', 'nickcage@gmail.com', 'zSoyNico03z', 8);

-- Grupo (alumnos)
insert into grupo (nombre, idProfesor) values ('Introducción a Biología', 8);

-- Examen (5)
INSERT INTO Examen (codigo, nombre, materia, fechaInicio, fechaFin, idGrupo) VALUES ('BIOEXA01', 'Examen de Tópicos', 'BiologíaI', '2023-06-01 09:00:00', '2023-06-30 11:00:00', 8);
INSERT INTO Examen (codigo, nombre, materia, fechaInicio, fechaFin, idGrupo) VALUES ('BIOEXA02', 'Examen de Tópicos (Segundo Periodo)', 'BiologíaII', '2023-06-01 09:00:00', '2023-06-30 11:00:00', 8);
INSERT INTO Examen (codigo, nombre, materia, fechaInicio, fechaFin, idGrupo) VALUES ('BIOEXA03', 'Examen Mediotermino', 'BiologíaIII', '2023-06-01 09:00:00', '2023-06-30 11:00:00', 8);
INSERT INTO Examen (codigo, nombre, materia, fechaInicio, fechaFin, idGrupo) VALUES ('BIOEXA04', 'Examen de Tópicos (Tercer Periodo)', 'BiologíaIIIV', '2023-06-01 09:00:00', '2023-06-30 11:00:00', 8);
INSERT INTO Examen (codigo, nombre, materia, fechaInicio, fechaFin, idGrupo) VALUES ('BIOEXA05', 'Examen Final', 'BiologíaV', '2023-06-01 09:00:00', '2023-06-30 11:00:00', 8);
...
-- Preguntas (1.2)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Qué es la teoría celular?', 2);
-- Respuestas (1.2)
...
-- Preguntas (1.3)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Cuáles son las excepciones a la teoría celular?', 3);
-- Respuestas (1.3)
...
-- Preguntas (1.4)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Qué son los organismos unicelulares?', 4);
-- Respuestas (1.4)
...
-- Preguntas (1.5)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Que puede probar la teoría celular?', 5);
-- Respuestas (1.5)
...
-- Preguntas (1.6)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Cuáles no es parte de las funciones vitales en un organismo?', 6);
-- Respuestas (1.6)
...
-- Preguntas (1.7)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Qué es verdad en las limitaciones del tamaño celular?', 7);
-- Respuestas (1.7)
...
-- Preguntas (1.8)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Qué son las células madre?', 8);
-- Respuestas (1.8)
...
-- Preguntas (1.9)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Cuál de las siguientes provee la energía a las células?', 9);
-- Respuestas (1.9)
...
-- Preguntas (1.10)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Qué son las membranas celulares?', 10);
-- Respuestas (1.10)
...
-- Preguntas (2.11)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Qué es la Biología Molecular?', 11);
-- Respuestas (2.11)
...
-- Preguntas (2.12)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿A qué se le conoce como Compuestos de Carbono?', 12);
-- Respuestas (2.12)
...
-- Preguntas (2.13)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Qué es el metabolismo?', 13);
-- Respuestas (2.13)
...
-- Preguntas (2.14)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Qué es el Anabolismo?', 14);
-- Respuestas (2.14)
...
-- Preguntas (2.15)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Qué son los puentes de hidrógeno?', 15);
-- Respuestas (2.15)
...
-- Preguntas (2.16)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Cuáles no son las propiedades del agua?', 16);
-- Respuestas (2.16)
...
-- Preguntas (2.17)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Cuáles de las siguientes son las propiedades térmicas del agua?', 17);
-- Respuestas (2.17)
...
-- Preguntas (2.18)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Cuáles son las diferencias entre el agua y el metano?', 18);
-- Respuestas (2.18)
...
-- Preguntas (2.19)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Qué son las proteínas?', 19);
-- Respuestas (2.19)
...
-- Preguntas (2.20)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Cuáles no son funciones de las proteínas?', 20);
-- Respuestas (2.20)
...
-- Preguntas (3.21)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Qué es un gen?', 21);
-- Respuestas (2.21)
...
-- Preguntas (3.22)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Dónde se encuentran los genes?', 22);
-- Respuestas (2.22)
...
-- Preguntas (3.23)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Qué son los alelos?', 23);
-- Respuestas (2.23)
...
-- Preguntas (3.24)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Qué es la mutación?', 24);
-- Respuestas (2.24)
...
-- Preguntas (3.25)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Qué es un genoma?', 25);
-- Respuestas (2.25)
...
-- Preguntas (3.26)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿De cuántes moleculas consta el genoma humano que forman los cromosomas?', 26);
-- Respuestas (2.26)
...
-- Preguntas (3.27)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Cuál es el nombre del gen que codifica un receptor de dopamina?', 27);
-- Respuestas (2.27)
...
-- Preguntas (3.28)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Cuál es el nombre del gen que codifica un una proteina del canal de cloruro?', 28);
-- Respuestas (2.28)
...
-- Preguntas (3.29)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Cuál es el número de cromosomas que contienen los perros?', 29);
-- Respuestas (2.29)
...
-- Preguntas (3.30)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Cuál es una descripción válida para los cromosomas X?', 30);
-- Respuestas (3.30)
...
-- Preguntas (4.31)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Que requieren los ecosistemas?', 31);
-- Respuestas (4.31)
...
-- Preguntas (4.32)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Qué son las especies?', 32);
-- Respuestas (4.32)
...
-- Preguntas (4.33)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Qué son las poblaciones?', 33);
-- Respuestas (4.33)
...
-- Preguntas (4.34)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Cuál de los siguientes tiene un metabolismo combinado?', 34);
-- Respuestas (4.34)
...
-- Preguntas (4.35)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Cuál de los siguiente es un consumidor?', 35);
-- Respuestas (4.35)
...
-- Preguntas (4.36)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Cuál de los siguiente es un Detritívoro?', 36);
-- Respuestas (4.36)
...
-- Preguntas (4.37)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Cuál de los siguiente es un Saprotrofo?', 37);
-- Respuestas (4.37)
...
-- Preguntas (4.38)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Cuál es una conversión posible de la energía lumínica?', 38);
-- Respuestas (4.38)
...
-- Preguntas (4.39)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Cómo se forma la turba?', 39);
-- Respuestas (4.39)
...
-- Preguntas (4.40)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Cómo ocurre la combustión?', 40);
-- Respuestas (4.40)
...
-- Preguntas (5.41)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Cuál es la función del páncreas?', 41);
-- Respuestas (5.41)
...
-- Preguntas (5.42)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Cuál de las siguientes no forma parte de la pared del intestino delgado?', 42);
-- Respuestas (5.42)
...
-- Preguntas (5.43)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Cuál de las siguientes no forma parte de la pared arterial?', 43);
-- Respuestas (5.43)
...
-- Preguntas (5.44)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Cuál de los siguientes son vasos sanguíneos?', 44);
-- Respuestas (5.44)
...
-- Preguntas (5.45)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Qué es el nódulo sinoauricular?', 45);
-- Respuestas (5.45)
...
-- Preguntas (5.46)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Célula encargada de ingerir patógenos?', 46);
-- Respuestas (5.46)
...
-- Preguntas (5.47)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Célula alveolar extremadamente fina y adaptada para el intercambio de gases?', 47);
-- Respuestas (5.47)
...
-- Preguntas (5.48)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Célula alveolar que segrega solución con surfactantes para reducir la tensión superficial?', 48);
-- Respuestas (5.48)
...
-- Preguntas (5.49)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿En la Inspiracióon, que hace la caja torácica?', 49);
-- Respuestas (5.49)
...
-- Preguntas (5.50)
INSERT INTO pregunta (pregunta, idExamen) VALUES ('¿Qué es la Sinapsis?', 50);
-- Respuestas (5.50)
